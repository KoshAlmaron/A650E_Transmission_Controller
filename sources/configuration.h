// Настройки.
	...
	#define SLU_MIN_VALUE 20			// Постоянное минимальное давление SLU.
	#define SLU_GLOCK_START_VALUE 50	// Давление схватвания блокировки гидротрансформатора.
	#define SLU_GLOCK_MAX_VALUE 180		// Максимальное давление блокировки гидротрансформатора.

	#define SLU_B3_MIN_VALUE 55			// Давление для временного отключения B3.
