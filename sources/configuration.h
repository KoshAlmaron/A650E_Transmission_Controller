// Настройки.
	...
	#define SLU_MIN_VALUE 20	// Постоянное минимальное давление блокировки гидротрансформатора.
	#define SLU_START_VALUE 66	// Давление начала схватывания блокировки гидротрансформатора.
