// Настройки.
	...
	// Количество импульсов на 1 км для выхода сигнала спидометра 0.
	#define SPEED_INPULS_PER_KM_0 6000LU
	// Количество импульсов на 1 км для выхода сигнала спидометра 1.
	#define SPEED_INPULS_PER_KM_1 6000LU
