// Настройки.
	...
	#define TPS_WOT_LIMIT 80			// Порог ДПДЗ для включения режима переключения по оборотам.

	#define MAX_SLIP_RPM 100			// Разница в оборотах валов для обнаружения проскальзывания.

	#define SLN_MIN_VALUE 33			// Постоянное минимальное давление в гидроаккумуляторах.
	...
	#define GLOCK_MAX_TPS 25			// Максимальное положение дросселя для блокировки гидротрансформатора.

	#define SOLENOID_BOOST_VALUE 150	// Значение буста при включении соленоида.
	#define SOLENOID_BOOST_TIME 60		// Время буста в мс.
